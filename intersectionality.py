...
# Define path to save results and save paths for each file
results_directory = os.path.join(current_directory, "results")
count_excel_save_path = os.path.join(results_directory, "intersectionality_count.xlsx")
count_figure_save_path = os.path.join(results_directory, "intersectionality_count.png")
percent_excel_save_path = os.path.join(results_directory, "intersectionality_percent.xlsx")
percent_figure_save_path = os.path.join(results_directory, "intersectionality_percent.png")
proportion_excel_save_path = os.path.join(results_directory, "intersectionality_proportion.xlsx")
proportion_figure_save_path = os.path.join(results_directory, "intersectionality_proportion.png")
...
s_count.to_excel(count_excel_save_path)
s_percent.to_excel(percent_excel_save_path)
s_proportion.to_excel(proportion_excel_save_path)
...
plt.savefig(percent_figure_save_path, bbox_inches="tight")
plt.close()
plt.clf()
...
plt.savefig(proportion_figure_save_path, bbox_inches="tight")
plt.close()
plt.clf()
...
plt.savefig(count_figure_save_path, bbox_inches="tight")
plt.close()
plt.clf()
