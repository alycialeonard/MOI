...
for i in items:
    ...
    # Save to Excel
    #item_filename_excel = "item_matrix_" + item_concat + "_percent.xlsx"
    ...
    if not r.empty:
        ax = plt.axes()
        g = sns.heatmap(r, ax=ax, cmap='Reds', annot=True, mask=mask, annot_kws={'size': 8}, fmt='.0f', vmin=0, vmax=100,
        ...
        #ax.set_title("Item matrix - " + i + " - General")
        # Save figure
        item_filename_figure = "item_matrix_" + item_concat + "_percent_general_mask.png"
